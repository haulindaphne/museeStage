<?php
/* 
 * Eight Degree Fly Menu - Skew Menu
 */
...
$edfm_skew_menu_animation = isset($edfm_fly_menu_settings[0]['edfm_skew_menu_animation'])? $edfm_fly_menu_settings[0]['edfm_skew_menu_animation']:'edfm_skew_menu_push';
$edfm_skew_menu_sub_menu_animation = isset($edfm_fly_menu_settings[0]['edfm_skew_menu_sub_menu_animation'])? $edfm_fly_menu_settings[0]['edfm_skew_menu_sub_menu_animation']:'edfm_skew_sub_menu_animation_1';
...
<div class="edfm-fly-menu-wrapper edfm-<?php esc_attr_e($postid);?>
	<?php
	esc_attr_e(' '.$edfm_menu_layout.' '.$edfm_skew_menu_template.' '.$edfm_skew_menu_position.' '.$edfm_skew_menu_sub_menu_type.' '.$edfm_skew_menu_animation.' '); if($edfm_skew_menu_blur_effect) esc_attr_e('edfm_blur_effect');
	?>"
	>
